...
class CommuteCheckRepository {
  ...
  Future<FbCommute> setCommute(String id,DateTime date,FbCommute fbCommute) => fbCommuteProvider.setCommute(id, date, fbCommute);

  Future<FbCommute> getCommute(String id, DateTime date) => fbCommuteProvider.getCommuteByDate(id, date);
